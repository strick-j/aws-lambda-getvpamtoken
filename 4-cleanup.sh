...
FUNCTION=$(aws cloudformation describe-stack-resource --stack-name $STACK --logical-resource-id CybrTokenFunction --query 'StackResourceDetail.PhysicalResourceId' --output text)
